    ...
    return function (attributes) { return function () {
        ...
        return {
            ...
            genKey: function (parentKey, index) {
                ...
                _this.attributes = _this.attributes || {};
                _this.attributes["key"] = geneKey + elementType;
            },
            render: function (parentKey, index) {
                var element = document.createElement(elementType);
                _this.genKey(parentKey, index);
                setAttributes(element)(_this.attributes);
                appendChildren(element)(_this.children)(0);
                return element;
            }
        };
    }; };
...
//# sourceMappingURL=muv-dom.js.map